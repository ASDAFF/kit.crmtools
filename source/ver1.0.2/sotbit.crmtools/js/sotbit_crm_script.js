    ...
    if(BX.CrmProductSearchDialogWindow)
        BX.CrmProductSearchDialogWindow.method("show", function(){
            BX.ajax({
                method: "GET",
                dataType: 'html',
                url: '/bitrix/services/sotbitrest/catalog.php?lang=ru&LID=s1&caller=order_edit&func_name=BX.Sale.Admin.OrderBasketObj.getParamsByProductId&STORE_FROM_ID=0&bxsender=core_window_cdialog',//this._settings.content_url,
                data: {},
                skipAuthCheck: true,
